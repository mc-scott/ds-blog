...
image-alt: "An abstract sketch who's colours bleed into the canvas"
code-annotations: hover
draft: false
toc: true
---

![Abstract Canvas](abstract-art-wide.png){fig-alt="A cropped version of the "}
```{r setup}
#| eval: true
#| echo: false
...
We will use the `mpg` data set in this tutorial and run through a lot of the common syntax used to manipulate a table.
