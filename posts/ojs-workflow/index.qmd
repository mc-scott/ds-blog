...
graph TD
    ...
    B --> C[Reference raw dataset in OJS cells]
...
Does this work when hosting JSON or Arrow files on GitHub? It should.
...
```{ojs}
data = await FileAttachment("https://raw.githubusercontent.com/mc-scott/ds-blog/refs/heads/main/posts/ojs-workflow/penguins.csv").csv()
```
